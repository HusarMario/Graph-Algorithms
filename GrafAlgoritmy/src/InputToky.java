 ...
 * @author user
 */
public class InputToky {
    private final BufferedReader bufferedReader;
    private final ArrayList<String> vrcholy;


    public InputToky(File file) throws FileNotFoundException {
    ...
    public Graf nacitajGraf() throws IOException {
        ...
        while ((line = this.bufferedReader.readLine()) != null) {
            ...
            graf.pridajHranuToku(zac, kon, Integer.parseInt(values[2]), Integer.parseInt(values[3]));
        }
